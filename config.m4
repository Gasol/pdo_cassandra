...
[cout << constant.VERSION << endl]])],
  ...
  PHP_NEW_EXTENSION(pdo_cassandra, pdo_cassandra.cpp cassandra_cql_parser.c cassandra_util.c cassandra_driver.cpp cassandra_statement.cpp, $ext_shared,, -I$pdo_cv_inc_path)
