...
$db->exec("CREATE KEYSPACE $keyspace WITH " .
    ...
    "strategy_options:replication_factor = 1") . PHP_EOL;
$db->exec("USE $keyspace") . PHP_EOL;
$db->exec("CREATE COLUMNFAMILY $columnFamily (KEY text PRIMARY KEY) WITH comparator = int");
